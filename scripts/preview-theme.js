...
const themeContribGuidelines = `
  ...
  \r> Read our [contribution guidelines](https://github.com/mdkausar295/github-readme-stats/blob/master/CONTRIBUTING.md) for more info
`;
...
async function run() {
  try {
    ...
    const url = `https://github-readme-stats.vercel.app/api?username=mdkausar295&title_color=${titleColor}&icon_color=${iconColor}&text_color=${textColor}&bg_color=${bgColor}&show_icons=true`;
